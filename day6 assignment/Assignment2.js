...
function insert(e) {
    e.preventDefault()  
    let bus = {};
    let ins_name = document.getElementById("name").value;
    let ins_source = document.getElementById("source").value;
    let ins_dest = document.getElementById("dest").value;
    let ins_number = document.getElementById("number").value;
    let ins_passcap = document.getElementById("passcap").value;
